...
if (totalPurchase >= 1000 && (buyCash && firstPurchase)) {
    ...
    console.log(`R$ ${nameClient,desconto.toFixed(2)} Reais de desconto`);
    console.log("R$",novoPreco.toFixed(2), " Reais o novo valor com desconto");
...
// Não é primeira compra e o pagamento não é a vista
